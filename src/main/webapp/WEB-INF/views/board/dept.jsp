...
<%
	...
	if (userInfo != null && loginId != null)
		System.out.println("dept.jsp : Session ok!!");
	else
		System.out.println("dept.jsp : Session invalidated!!");
%>
	...
	<div id="wrap">
		...
		<div id="header">
			...
			<div class="page-header">
				<h1>
					Dept 리스트&nbsp;&nbsp;<small>현재 "<%=loginId%>"님으로 로그인 하셨습니다.
					</small>
				</h1>
			</div>
			...
			<ul class="nav nav-pills nav-justified navbar-static-top">
				...
				<li class="active"><a href="/michiget/dept">부서리스트</a></li>
